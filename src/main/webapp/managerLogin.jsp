...
<div class="el-header" >
	...
	<div class="navbar navbar-default el-navbar">
		<div class="container">
			<div class="navbar-header">
				...
				<span>Only for the Manager</span>
			</div>
		</div>
	</div>
	...
	<div class="container">  
		<form id="loginForm" class="form-horizontal el-login-form" action="/ManagerServlet" method="post" >
		<input type = "hidden" name="method" value="login">
		<br>
			<p class="h2" style="margin: 10px 10px 20px 110px;color:#000;">&emsp;Manager Login</p> 
			<div class="form-group">
				<label class="control-label col-sm-2">Email</label>
				<div class="col-sm-10">
					<input type="text" autocomplete="off" name="email" class="form-control" value="${manager.email }"/>
				</div> 
			</div>
			<br>
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="password" autocomplete="off" name="password" class="form-control" value="${maanger.password }" />
